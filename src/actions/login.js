...
export const addLogin = (payload) =>{
    ...
    return dispatch => {
        fetch('http://localhost:8070/login', requestOptions)
            .then(res => {
                console.log(res)
                if(res.status === 201){
                    console.log("success");
...
export const ChangePassword = (user) =>{
    ...
    return dispatch => {
        fetch('http://localhost:8070/loginchangePassword/'+ user.userId  , requestOptions)
            .then(res => {
                console.log(res)
...
export const deleteLogin = (userId) => {
    ...
    return dispatch => {
        fetch("http://localhost:8070/login/" + userId, requestOptions)
            .then(res => {
                if (res.status === 200) {
                    dispatch(fetchLogin())
